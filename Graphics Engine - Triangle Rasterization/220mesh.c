/*
	220mesh.c
	Creates the meshMesh struct and defines methods to implement it, including meshRender. Differs from 200mesh.c by using sha->shadeVertex instead of shadeVertex().
