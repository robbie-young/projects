/*
    120mainPointers.c
    Example file demonstrating implementations and functions of pointers in C.
...
long street. Instead of having street addresses like '110 Winona St', they 
would have street addresses like '200343000268'. That is, the street numbers 
would be many digits long (instead of '110'), and there would be no reason to 
...
actually quite simple:
    ...
    B. If you have a pointer, you can access the variable it points to using *.
    C. You also use * to declare a variable that has pointer type.
The code below illustrates these concepts. */

/* On macOS, compile with...
    clang 120mainPointers.c
On Ubuntu, compile with...
    cc 120mainPointers.c
*/
